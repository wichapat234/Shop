#pragma checksum "D:\Shop\Shop\Views\Transaction\Add_Bill.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "999fdd1eae2bfd9aea3876292bfc9ed160fe5397"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"999fdd1eae2bfd9aea3876292bfc9ed160fe5397", @"/Views/Transaction/Add_Bill.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "999fdd1eae2bfd9aea3876292bfc9ed160fe53973117", async() => {
...
<script>
     ...
     ");
        ...
        for (let i = 0; i <= totalRowCount - 2; i++) {
            ...
            if (select[i].value == """") {
                ...
                document.ge");
            WriteLiteral(@"tElementById(selectnameid).classList.add(""validate"");
                valid = 0;
        ...
        if (valid == 0) {
            ...
            axios({
                ...
                dataType: 'json',
              ");
            WriteLiteral(@"  url: '/Transaction/insert_detail_bill ',
                data: data
            })
    ...
    function Calculate_Discount() {
        ...
        for (let i = 0; i < dis.length; i++) {
            let di");
            WriteLiteral(@"svalue = dis[i].value;
            if (disvalue == """") {
                disint = 0;
            } else {
    ...
    function setrow() {
        ...
        //    selectList.value = ""xxx"";
            ...
            selectList.onchange = function () { //ฟังก์ชัน OnChange สินค้า
                ...
                document.getElementById(""discount"" + cache).");
            WriteLiteral(@"value = """";
            ...
            input_count.value = """";
            input_count.className = ""c");
            WriteLiteral(@"ountclass"",""is-invalid"";
           // input_count.required;
            ...
            const price = document.createElement(""h""); //");
            WriteLiteral(@"สร้าง element แสดงราคา/ชิ้น
           ...
           discount.value = """";
            ...
            discount.onkeyup = function () { //ฟังก์ชัน OnKeyUp ส่วนลด
                ...
                if (dis_pro > sum_pro) {
                    discount_product = document.getElementById(""discount"" ");
            WriteLiteral(@"+ cache).value = sum_product
                }
                let total_product = 0;
            ...
            currentCell = ");
            WriteLiteral(@"TableRow.insertCell(-1);
