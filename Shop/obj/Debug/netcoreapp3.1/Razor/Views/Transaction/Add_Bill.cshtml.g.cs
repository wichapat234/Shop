#pragma checksum "D:\Shop\Shop\Views\Transaction\Add_Bill.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "da7746063badb2aacfa7201593f1e874ca9c124b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"da7746063badb2aacfa7201593f1e874ca9c124b", @"/Views/Transaction/Add_Bill.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "da7746063badb2aacfa7201593f1e874ca9c124b3117", async() => {
...
<script>
     ...
     ");
        ...
        for (let i = 0; i <= totalRowCount - 2; i++) {
            ...
            if (select[i].value == """") {
                ...
                document.getEle");
            WriteLiteral(@"mentById(selectnameid).classList.add(""validate"");
                valid = 0;
        ...
        if (valid == 0) {
            ...
            axios({
                ...
                dataType: 'json',
                ur");
            WriteLiteral(@"l: '/Transaction/insert_detail_bill ',
                data: data
            })
    ...
    function setrow() {
        ...
        //    selectList.value = ""xxx"";
            ...
            input_count.value = """";
            input_count.className = ");
            WriteLiteral(@"""countclass"",""is-invalid"";
