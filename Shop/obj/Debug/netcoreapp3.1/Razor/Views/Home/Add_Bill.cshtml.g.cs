#pragma checksum "D:\Shop\Shop\Views\Home\Add_Bill.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7b31de642a00a024fca1a4aa33f1bd0502ee1a52"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7b31de642a00a024fca1a4aa33f1bd0502ee1a52", @"/Views/Home/Add_Bill.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7b31de642a00a024fca1a4aa33f1bd0502ee1a523266", async() => {
...
<script>
    ...
    function Calculate_Discount(count) {
        ...
        for (var i = 1; i <= count; i++) { //Calculate Discount
            let dis_value = document.ge");
            WriteLiteral(@"tElementById(""discount"" + i).value
            if (dis_value == """") {
                dis_value = 0;
            }
...
");
            WriteLiteral(@"                        document.getElementById(""count"" + cache).value = """";
     ...
     ");
            WriteLiteral(@"                   selectList.appendChild(option);
                    }
            ...
            WriteLiteral(@"_Sum(count);
                    ...
                    discount.onkeyup = function () { //ฟังก์ชัน OnKeyUp ส่วนลด
                        ...
                        let discount");
            WriteLiteral(@"_product = document.getElementById(""discount"" + cache).value
                        let total_product = 0;
            ...
            WriteLiteral(@" TableRow.insertCell(-1);
                    ...
                    document.getElementById(""save_bill"").onclick = function () {
                        ...
                        for (var i = 1; i <= count; i++) {
                            ...
                            var count_p = docum");
            WriteLiteral(@"ent.getElementById(""count"" + i).value
                        ...
                        var sad = parseFloat(s");
            WriteLiteral(@"um_af_dis)
                        ...
                        axios({
                            ...
                            dataType: 'json',
                            url");
            WriteLiteral(@": '/Home/insert_detail_bill ',
                            data: arry
                        })
                            .then(function (response) {
                                console.log(response);
