#pragma checksum "D:\Shop\Shop\Views\Home\Add_Bill.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7465a55a36106ffb3ff7125b6b840c533258db35"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7465a55a36106ffb3ff7125b6b840c533258db35", @"/Views/Home/Add_Bill.cshtml")]
    ...
    public class Views_Home_Add_Bill : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<bill_idViewmodel>
    {
        #line hidden
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7465a55a36106ffb3ff7125b6b840c533258db353263", async() => {
...
<script>
    ...
    function save_bill() {
        ...
        var obj = { PriceBefore: sbf, TotalDiscount: std, PriceAfter: sad, Date: dateTime }

        for ");
            WriteLiteral(@"(var i = 1; i <= totalRowCount-1; i++) {
    ...
    function Calculate_Total(count) {
        var total_cal = 0;
        for (var i = 1; i <= count; i++) { //Calculate Total
            let total_value = document.getElementById(""total"" + i).innerHTML
            if (total_value == """") {
                total_value = 0;
            }
            var total_int = parseFloat(total_value);
            total_cal += total_int;
        } 
    ...
    function addrow() {
        axios({
                    ...
                    selectList.onchange = function () { //ฟังก์ชัน OnChange สินค้า
                        ...
                        for (let x = 0; x < response.data.product.length; x++) {
                            if (value1 == response.data.product[x].product_Id) {
                                ...
                                document.getElementById(""price"" + cache).innerHTML = response.data.product[x].productPri");
            WriteLiteral(@"ce;
                            }
                        }
              ...
              ");
            WriteLiteral(@"          option.text = response.data.product[i].nameProduct;
                    ...
                    input_count.onkeyup = function () { //ฟังก์ชัน OnKeyUp จำนวน
                        ...
                        document.getElementById(""sum"" + cache).i");
            WriteLiteral(@"nnerHTML = sum_product.toFixed(2)
                        Calculate_Sum(count);
                    }
                    ...
                    discount.onkeyup = function () { //ฟังก์ชัน OnKeyUp ส่วนลด
                        let sum_product = ");
            WriteLiteral(@"document.getElementById(""sum"" + cache).innerHTML
           ...
           ");
            WriteLiteral(@"         currentCell.appendChild(unit); // แสดงหน่วยสินค้า
...
<style>
    ...
    th {
       ");
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<bill_idViewmodel> Html { get; private set; }
    }
}
