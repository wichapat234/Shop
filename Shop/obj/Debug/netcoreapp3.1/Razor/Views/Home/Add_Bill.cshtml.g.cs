#pragma checksum "D:\Shop\Shop\Views\Home\Add_Bill.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "720c150cdaf9a598a132e04adeffa7932d0561a4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"720c150cdaf9a598a132e04adeffa7932d0561a4", @"/Views/Home/Add_Bill.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "720c150cdaf9a598a132e04adeffa7932d0561a43266", async() => {
    ...
    function addrow() {
        axios({
            ...
            .then(function (response) {
                ...
                //if (response.data.billDetail == null) {
                //    var numbill = 0;
                //} else {
                //    numbill = response.data.billDetail.idBill
             ");
            WriteLiteral(@"   //}
                //const str = 'Bill-'
                //numbill++ 
                //str2 = str + numbill++ 
                //document.getElementById(""bill_number"").innerHTML = str2
                var count = 0;
                document.getElementById(""add_bill"").onclick = function () {
                   ...
                   ");
            WriteLiteral(@"         if (value1 == response.data.product[x].product_Id) {
            ...
            WriteLiteral(@"
                    ...
                    var discount = document.createElement(""input"");//สร้าง element ");
            WriteLiteral(@"input ส่วนลด
       ...
       ");
            WriteLiteral(@"             currentCell.appendChild(selectList);  //เลือกสินค้า
            ...
            WriteLiteral(@"                   
                       ...
                       /* var name_bill_str = document.getElementById(""bill_number"").innerHTML*/
                        ...
                        for (var i = 1; i <= count; i++) {
                            ...
                            var total_p = document.getElementById(""");
            WriteLiteral(@"total"" + i).innerHTML
